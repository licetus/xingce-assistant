...
```js
{
  ...
  exams:    ['2024行政执法',          // 真题出处数组（2026-09-08 新增并全量回填）。一题多卷是国考
            '2024地市级'],            // 常态（各卷共享题目），无法归属单一卷别时有多项。
                                     // 卡片标签展示：单卷「2024国考·行政执法」/ 同年多卷
                                     // 「2024国考·执法/地市」/ 跨年「2024/2025国考」。
                                     // ⚠️ 归属勘误史与对照表见 database/raw/PAPER-MAPPING.md；
                                     // tags 里的「国考YYYY」仅保留年份，卷别细节以本字段为准
  status:   1,                       // 1 上架 / 0 下架
